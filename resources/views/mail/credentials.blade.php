            ...
            <tbody>
                <tr>
                    <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
                        ...
                        <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Bienvenid@ al escaperoom f5</h1>

                        <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">Advertencia: cuando toques el botón asumiremos que estás listo para comenzar a jugar.</p>
                ...
                <![endif]-->
                            ...
                            <span style="mso-text-raise: 15pt; color: #ffffff;">Iniciar</span>
                            <!--[if mso]>
            ...
            <tbody>
                <tr>
                    <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;" width="596">
                        ...
                        <h1 style="text-align:center !important; color:white">404</h1>
